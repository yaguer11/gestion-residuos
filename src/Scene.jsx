...
export default function Scene({
  ...
  return (
    ...
    >
      ...
      {/* ── Letras VM — monumento de la plaza de Villa Mercedes ── */}
      <LetrasVM position={[1.5, 0, -4.2]} />
